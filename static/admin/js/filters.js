...
{
    // Init filters.
    let filters = JSON.parse(sessionStorage.getItem('django.admin_interface.filtersState'));
    ...
    details.forEach(detail => {
        detail.addEventListener('toggle', event => {
            ...
            sessionStorage.setItem('django.admin_interface.filtersState', JSON.stringify(filters));
        });
    });
}
