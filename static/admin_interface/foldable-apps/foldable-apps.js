(function() {
    window.onload = function() {
        for (let moduleEl of document.querySelectorAll('.admin_interface-interface.foldable-apps [class^="app-"].module')) {
            ...
            if (moduleAppClass) {
                let moduleAppKey = 'admin_interface-interface.foldable-apps_' + moduleAppClass + '_collapsed';
